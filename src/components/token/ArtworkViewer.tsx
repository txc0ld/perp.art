...
export function ArtworkViewer({ token }: { token: Token }) {
  ...
  return (
    <div>
      {/* Framed artwork */}
      <div className="group relative overflow-hidden rounded-[8px] border border-border bg-background">
        ...
        <button
          ...
          className={cn(
            "absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-[8px]",
